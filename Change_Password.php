...
<div class="login-form">
	...
	<img src="banks.jpg" alt="Avatar" style="width:90px;height:70px;border-radius: 50%;" class="avatar">
        ...
        <div class="form-group">
            <input type="password" class="form-control" id="Opass" name="Opassword" placeholder="Old Password" required="required">
        </div> 
		<div class="form-group">
            <input type="password" class="form-control" id="Npass" name="Npassword" placeholder="New Password" required="required">
        </div> 
		<div class="form-group">
            <input type="password" class="form-control" id="Cpass" name="Cpassword" placeholder="Confirm Password" required="required">
        </div> 
...
header('location:Change_Transfer.php');
exit();
...
{ ?>
	<script>
	 $("#Npass").attr("placeholder","It should be min 6 character").css( {'border-color':'#de3116'});
	</script>
	<?php
	$st=1;
}
...
{?>
	<script>
	 $("#Cpass").attr("placeholder","It should match New Password").css( {'border-color':'#de3116'});
	</script>
	<?php
	$st=1;
}
