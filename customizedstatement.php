...
<div class="login-form">
	...
	<img src="banks.jpg" alt="Avatar" style="width:90px;height:70px;border-radius: 50%;"class="avatar">
		...
		<div class="form-group">
            <input type="date" class="form-control" name="fdate" placeholder="From Date" required="required">
        </div>
		<div class="form-group">
            <input type="date" class="form-control" name="tdate" placeholder="To Birth" required="required">
        </div>
		<div class="form-group">
            <input type="number" class="form-control" name="amount" placeholder="Amount lower limit" required="required">
        </div>
		<div class="form-group">
            <input type="number" class="form-control" name="num" placeholder="Number Of Transaction" required="required">
        </div>
