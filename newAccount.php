...
<div class="login-form">
	...
	<img src="banks.jpg" alt="Avatar" style="width:90px;height:70px;border-radius: 50%;"class="avatar">
        ...
        <div class="form-group">
            <input type="Text" class="form-control" name="id" placeholder="Customer Id" required="required">
        </div>
  ...
  <label class="input-group-text" for="inputGroupSelect02">Select</label>
		...
		<div class="form-group">
            <input type="number" class="form-control" name="number" id="deposite" placeholder="Initial Deposite" required="required">
        </div>	
         <div class="form-group">
