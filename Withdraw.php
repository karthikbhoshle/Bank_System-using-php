...
<div class="login-form">
	...
	<img src="banks.jpg" alt="Avatar" style="width:90px;height:70px;border-radius: 50%;" class="avatar">
        ...
        <div class="form-group">
            <input type="Text" class="form-control" name="Acnum" id="Acnum" placeholder="Account Number" required="required">
        </div>
		
		<div class="form-group">
            <input type="Number" class="form-control" name="Amount" id="Amount" placeholder="Amount Deposit" required="required">
        </div>
