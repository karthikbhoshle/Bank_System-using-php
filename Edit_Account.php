...
<div class="login-form">
	...
	<img src="banks.jpg" alt="Avatar" style="width:90px;height:70px;border-radius: 50%;" class="avatar">
        ...
        <div class="form-group">
            <input type="Text" class="form-control" name="Cid" id="Cid" placeholder="Account Number" required="required">
        </div>
...
$Cin=$_POST['Cin'];
	...
	header('location:Edit_Account1.php');
exit();
