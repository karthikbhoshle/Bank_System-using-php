...
<script src = "https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    ...
    <title>Customized_Statement</title>
  </head>
...
<div class="login-form">
	...
	<img src="banks.jpg" alt="Avatar" style="width:90px;height:70px;border-radius: 50%;" class="avatar">
        <h2 class="text-center">Customized Statement</h2>   
         <div class="form-group">
            <input type="Text" class="form-control" name="Account" id="Account" placeholder="Account No" required="required">
        </div>
		<div class="form-group">
            <input type="Date" class="form-control" name="Fdate" id="Fdate" placeholder="From Date" required="required">
        </div>
		<div class="form-group">
            <input type="Date" class="form-control" name="Tdate" id="Tdate" placeholder="To Date" required="required">
        </div>
		<div class="form-group">
            <input type="Number" class="form-control" name="Ntran" id="Ntran" placeholder="Number Of Transaction" required="required">
        </div>
...
header('location:Customized_Statement.php');
exit();
